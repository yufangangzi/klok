...
function convertToMono( input ) {
    ...
    //第二个和第三个参数，分别用来指定通道链接来源的索引和输出的索引。
...
function createLPInputFilter() {
    //方法创建了一个  BiquadFilterNode, 它提供了一个可以指定多个不同的一般滤波器类型的双二阶滤波器。
...
//    realAudioInput = audioContext.createMediaStreamSource(stream);
    ...
    var audioSource=audioContext.createMediaElementSource(myAudio)
...
*/
    ...
    // create mix gain nodes 创建混合增益节点
